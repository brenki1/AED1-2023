...
void maiorAluno(Lista *l){
    ...
    //buscarNotaChave(l, maior->n1, maior);

    printf("O aluno com a maior nota: Matricula: %d\nNome: %s\nNota: %f\n", maior->mat, maior->nome, maior->n1);
}
